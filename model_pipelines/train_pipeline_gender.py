...
X = df.drop(columns=['person', 'gender'])
y = df['gender']
...
model_path = f'../saved_models/model_gender_{best_model.named_steps["classifier"].__class__.__name__}.pkl'
...
print_metrics2(loaded_model, y=df_valid['gender'], y_pred=valid_predicted)

valid_table = df_valid[['person']].copy()
valid_table['gender_original'] = df_valid['gender']
valid_table['gender_predicted'] = valid_predicted
display(valid_table)
